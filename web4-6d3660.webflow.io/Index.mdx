...
> Welcome to the new home for your documentation
  ...
  [web4-6d3660.webflow.io](https://acme-83ff5188.mintlify.app/index.md)
## Setting up
...
<Card title="See complete examples" icon="stars" href="https://mintlify.com/acme-83ff5188.mintlify.app/index.md">
  Browse our showcase of exceptional documentation sites.
</Card>

---

> To find navigation and other pages in this documentation, fetch the llms.txt file at: a `[link to application](https://web4-6d3660.webflow.io/docs/llms.txt
